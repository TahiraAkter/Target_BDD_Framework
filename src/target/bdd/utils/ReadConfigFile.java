...
public class ReadConfigFile {
	...
	public static ReadConfigFile getInstance() { //for singleton --- >getter method to access the 'readConfigFile' object in another class
		                                                       // because the constructor of that Class is private. 
		if (readConfigFile==null) { // if the object is not initialized                 
			readConfigFile=new ReadConfigFile(); // then initialize it over here
		}
